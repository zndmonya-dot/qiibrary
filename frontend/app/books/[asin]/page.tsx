                ...
                <div className="space-y-1.5 md:space-y-2">
                  {book.qiita_articles.slice(0, displayedArticlesCount).map((article, index) => {
                    ...
                    <a
                      ...
                      className="group block p-2.5 md:p-3 rounded-lg bg-qiita-surface dark:bg-dark-surface-light hover:bg-qiita-green/5 dark:hover:bg-qiita-green/10 transition-all duration-200"
                      style={style}
                    >
